                ...
                <div className="col-md-12">
                  <div className="arrivals-wrap item-wrapper">
                    ...
                    >
                      ...
                      <div className="col-md-12 ">
                        <div
                          className="40344357634128 theme-product theme-product-action-on-hover mb-30 
                                 theme-product-action-middle
                                 theme-product-countdown-bottom
                                 product-wrapper-class"
                        >
                          <div className="theme-product-inner icon_bg grid__style__2">
                            <div className="theme-product-image-wrap product-color">
                              <div className="theme-product-image">
                                <div className="theme-product-cus-tab icon_bg_img">
                                  <a
                                    href="products/whispers-of-the-enchanted-forest.html"
                                    className="theme-product-image"
                                  >
                                    <img
                                      className="popup_cart_image"
                                      src="Assets/shop/files/p4_largefdd6.png?v=1697897376"
                      ...
                      <div className="col-md-12 ">
                        <div
                          className="40344366350416 theme-product theme-product-action-on-hover mb-30 
                                 theme-product-action-middle
                                 theme-product-countdown-bottom
                                 product-wrapper-class"
                        >
                          <div className="theme-product-inner icon_bg grid__style__2">
                            <div className="theme-product-image-wrap product-color">
                              ...
                              <div className="theme-product-image">
                                <div className="theme-product-cus-tab icon_bg_img">
                                  <a
                                    href="products/the-short-stoye-of-olivia.html"
                                    className="theme-product-image"
                                  >
                                    <img
                                      className="popup_cart_image"
                                      src="Assets/shop/files/p5_largee410.png?v=1697897936"
                              ...
                              <div className="theme-product-content-inner ">
                                ...
                                <h4 className="theme-product-title popup_cart_title">
                                  <a href="products/the-short-stoye-of-olivia.html">
                                    The Short Stoye Of Olivia
                                  </a>
                                </h4>
                                <div className="theme-product-price ">
                                  <span className="old">Rs. 440.00</span>
                                  <span className="new">Rs. 423.44</span>
                                </div>
                                <div className="theme-product-ratting-wrap ">
                                  <span className="theme-product-ratting spr-badge-caption-none">
                                    <span
                                      className="shopify-product-reviews-badge"
                                      data-id={6885545017424}
                                    />
                                  </span>
                                </div>
                              </div>
                      ...
                      <div className="col-md-12 ">
                        <div
                          className="40344364974160 theme-product theme-product-action-on-hover mb-30 
                                 theme-product-action-middle
                                 theme-product-countdown-bottom
                                 product-wrapper-class"
                        >
                          <div className="theme-product-inner icon_bg grid__style__2">
                            <div className="theme-product-image-wrap product-color">
                              <div className="theme-product-image">
                                <div className="theme-product-cus-tab icon_bg_img">
                                  <a
                                    href="products/the-galaxy-of-glory-story.html"
                                    className="theme-product-image"
                                  >
                                    <img
                                      className="popup_cart_image"
                                      src="Assets/shop/files/p14_008a1def-2d63-448a-907c-9f2856d9679e_large245f.png?v=1697900347"
                              ...
                              <div className="theme-product-content-inner ">
                                ...
                                <h4 className="theme-product-title popup_cart_title">
                                  <a href="products/the-galaxy-of-glory-story.html">
                                    The Galaxy Of Glory Story
                                  </a>
                                </h4>
                                <div className="theme-product-price ">
                                  <span className="new">Rs. 452.95</span>
                                </div>
                                <div className="theme-product-ratting-wrap ">
                                  <span className="theme-product-ratting spr-badge-caption-none">
                                    <span
                                      className="shopify-product-reviews-badge"
                                      data-id={6885544689744}
                                    />
                                  </span>
                                </div>
                              </div>
                      ...
                      <div className="col-md-12 ">
                        <div
                          className="40344367595600 theme-product theme-product-action-on-hover mb-30 
                                 theme-product-action-middle
                                 theme-product-countdown-bottom
                                 product-wrapper-class"
                        >
                          <div className="theme-product-inner icon_bg grid__style__2">
                            <div className="theme-product-image-wrap product-color">
                              <div className="theme-product-image">
                                <div className="theme-product-cus-tab icon_bg_img">
                                  <a
                                    href="products/tales-from-the-forgotten-realms.html"
                                    className="theme-product-image"
                                  >
                                    <img
                                      className="popup_cart_image"
                                      src="Assets/shop/files/p6_53765593-0f7a-4dbc-bd4c-2ac6538b9447_large39c3.png?v=1697898172"
            ...
            <div className="container default ">
              ...
              <div className="product-menu-banner-wrapper row">
                <div className="col-md-12">
                  <div className="arrivals-wrap item-wrapper">
                    <div
                      className="theme-products custom_mobile_class  feature-product-slider-active carsoule_arrow_style row"
                      data-slick='{
                           "infinite": true,
                           "slidesToShow": 4,
                           "slidesToScroll": 1,
